...
//   return (
//     <nav className="bg-gray-100 px-8 py-2 flex justify-between items-center">
//       <Link to="/" className="text-2xl font-bold text-blue-600">
//       <img src="./logo.jpg" alt="" className="h-16 rounded-xl shadow-xl" />
//       </Link>
...
//         ) : (
//           <Link to="/auth">
//             <button className="bg-green-500 text-white px-4 py-2 rounded shadow-xl cursor-pointer">Sign In</button>
//           </Link>
//         )}
//       </div>
//     </nav>
...
//   const [ setIsSidebarOpen] = useState(false); // For controlling sidebar visibility
...
//   return (
//     <nav className="bg-gray-100 px-8 py-2 flex justify-between items-center shadow-lg">
//       {/* Logo */}
//       <Link to="/" className="text-2xl font-bold text-blue-600">
...
//                 setIsSidebarOpen(false); // Close sidebar when profile is clicked
//               }}
...
//         ) : (
//           <Link to="/login">
//             <button className="bg-green-500 text-white px-4 py-2 rounded shadow-xl cursor-pointer">
//               Sign In
//             </button>
//           </Link>
//         )}
